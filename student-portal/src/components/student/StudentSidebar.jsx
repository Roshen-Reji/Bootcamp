...
import { subscribeToStudent } from '@/lib/db'; // ADDED: Import the real-time listener
import styles from '@/components/admin/AdminSidebar.module.css'; // Reusing base sidebar CSS
...
export default function StudentSidebar() {
  ...
  // ADDED: Listen for real-time changes to the student's level
  useEffect(() => {
  ...
  // ADDED: Calculate the live level to display, ensuring it is capitalized
            ...
            <AnimatePresence>
              {(isExpanded || isMobileOpen) && (
                ...
                >
                  ...
                  {/* CHANGED: Now uses the live updating displayLevel */}
