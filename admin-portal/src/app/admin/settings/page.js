      ...
      >
          ...
          >
            <GlassCard hover={false} padding="lg">
              <div className={styles.sectionHeader}>
                <div className={styles.sectionIcon} style={{ background: 'rgba(108, 99, 255, 0.15)', color: '#6C63FF' }}>
                  <UserIcon />
                </div>
                <div>
                  <h2 className={styles.sectionTitle}>Profile Information</h2>
                  <p className={styles.sectionDesc}>Update your display name and account details</p>
                </div>
              </div>
              ...
              <div style={{ marginTop: '32px', paddingTop: '24px', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
                <h3 style={{ fontSize: '1.1rem', color: '#ff4757', margin: '0 0 8px 0' }}>Danger Zone</h3>
                <p style={{ color: '#94a3b8', fontSize: '0.9rem', marginBottom: '16px' }}>Sign out of your account on this device.</p>
                <button
                  type="button"
                  onClick={logout}
                  className="btn"
        ...
        {activeTab === 'security' && (
          ...
          >
            <GlassCard hover={false} padding="lg">
              <div className={styles.sectionHeader}>
                <div className={styles.sectionIcon} style={{ background: 'rgba(46, 213, 115, 0.15)', color: '#2ed573' }}>
                  <LockIcon />
                </div>
                <div>
