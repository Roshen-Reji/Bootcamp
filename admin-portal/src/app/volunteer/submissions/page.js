// admin-portal/src/app/volunteer/submissions/page.js
'use client';
...
export default function VolunteerSubmissions() {
  ...
  // Group the submissions by student so we can render them as an accordion
    ...
    <div className={styles.container}>
      ...
      <div className={styles.header}>
        <div>
          ...
          <p className={styles.subtitle}>Review and grade submissions from your students</p>
        </div>
      </div>
          ...
          <GlassCard hover={false} padding="xl">
            <div className="empty-state">
              ...
              <p className="empty-state-text">
                {filter === 'pending' ? 'No submissions waiting for review. Great job!' : "You're all caught up!"}
              </p>
            </div>
          </GlassCard>
        ) : (
          groupedSubmissions.map((group, i) => (
            ...
            >
              <GlassCard padding="none">
                ...
                {/* Accordion Body (The Submissions List) */}
