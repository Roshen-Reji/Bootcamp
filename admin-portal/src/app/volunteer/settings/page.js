    ...
    <div className={styles.container}>
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>Manage your reviewer account</p>
        </div>
          ...
          <GlassCard hover={false} padding="lg">
            <div className={styles.sectionHeader}>
              ...
              <div>
                ...
                <p className={styles.sectionDesc}>Update the name shown to students and admins</p>
              </div>
            </div>
            ...
            <form onSubmit={handleProfileUpdate} className={styles.form}>
              ...
              <div className={styles.formGroup}>
                ...
                <input className={styles.input} type="text" value="Volunteer / Reviewer" disabled />
              </div>
              {profileMsg && (
